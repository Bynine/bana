...
public class Level_Oasis extends Level{
	...
	public Level_Oasis(){
		artifact = new Artifact(TILE*15, TILE*8, Artifact.Type.CHEST);
	...
	public ArrayList<Collectible> oasisStartList = new ArrayList<Collectible>(Arrays.asList(
			...
			new Coin(TILE*1, TILE*12, Coin.Type.GEM),
	...
	public ArrayList<Collectible> oasisMiddleList = new ArrayList<Collectible>(Arrays.asList(
			new Coin(TILE*6, TILE*6, Coin.Type.COIN),
			new Coin(TILE*6, TILE*7, Coin.Type.COIN),
			new Coin(TILE*7, TILE*7, Coin.Type.COIN),
			new Coin(TILE*8, TILE*7, Coin.Type.COIN),
			new Coin(TILE*8, TILE*6, Coin.Type.COIN)
			));
	public ArrayList<Collectible> oasisEndList = new ArrayList<Collectible>(Arrays.asList(
			...
			new Coin(TILE*99, TILE*11, Coin.Type.GEM),
